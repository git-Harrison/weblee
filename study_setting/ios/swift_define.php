    ...
    <main class="html">
        <div class="container">
            ...
            <div class="list">
                ...
                <ul>
                    <li>
                        <a href="https://docs.swift.org/swift-book/LanguageGuide/TheBasics.html" target="_blank">
                            Swift 공식 문서 - <span>https://docs.swift.org/swift-book/LanguageGuide/TheBasics.html</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.swift.org/documentation/api-design-guidelines/" target="_blank">
                            Swift api 가이드 라인 - <span>https://www.swift.org/documentation/api-design-guidelines/</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://developer.apple.com/tutorials/swiftui" target="_blank">
                            SwiftUI 공식 문서 -<span>https://developer.apple.com/tutorials/swiftui</span>
                        </a>
                    </li>
                </ul>
            </div>
