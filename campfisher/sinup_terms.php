...
<!-- 			<a href="" title="쇼핑몰로고">
                ...
                <div class="chk_all">
                	<div>
                		<input type="checkbox" id="chk_all" name="terms" onclick='selectAll(this)'>
                	</div>
                	<label for="chk_all">
                		<span class="chk_all_txt">캠피셔 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택),<br>프로모션 정보 수신(선택)에 모두 동의합니다.</span>
                	</label>
                </div>
                <div class="chk">
                	<div>
                		<input type="checkbox" id="termsService" name="terms">
                	</div>
                	<label for="termsService">
                		<span class="chk_txt">캠피셔 이용약관 동의<strong>(필수)</strong></span>
                	</label>
                	<div class="terms_box">
						제1조(목적)<br>
						<br>
                ...
                <div class="chk">
                	<div>
                		<input type="checkbox" id="termsPrivacy" name="terms">
                	</div>
                	<label for="termsPrivacy">
                		<span class="chk_txt">개인정보 수집 및 이용 동의<strong>(필수)</strong></span>
                	</label>
                	<div class="terms_box">
						개인정보보호법에 따라 캠피셔에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.<br><br>
						1. 수집하는 개인정보<br>
						이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 캠피셔 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 캠피셔는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.<br>
						<br>
						회원가입 시점에 캠피셔가 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br><br>
						...
						campfisher 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.
						<br>
						서비스 이용 과정에서 IP 주소, 쿠키, 서비스 이용 기록, 기기정보, 위치정보가 생성되어 수집될 수 있습니다. 또한 이미지 및 음성을 이용한 검색 서비스 등에서 이미지나 음성이 수집될 수 있습니다.<br><br>
						구체적으로<br>1) 서비스 이용 과정에서 이용자에 관한 정보를 자동화된 방법으로 생성하여 이를 저장(수집)하거나,
						2) 이용자 기기의 고유한 정보를 원래의 값을 확인하지 못 하도록 안전하게 변환하여 수집합니다. 서비스 이용 과정에서 위치정보가 수집될 수 있으며,
						캠피셔에서 제공하는 위치기반 서비스에 대해서는 '캠피셔 위치정보 이용약관'에서 자세하게 규정하고 있습니다.
						이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.<br>
						<br>
						2. 수집한 개인정보의 이용<br>
						캠피셔 및 캠피셔 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.
						<br>
						...
						- 법령 및 캠피셔 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.
						...
						전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. 캠피셔는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.
						...
						로그인 기록: 3개월
						<br>
						참고로 캠피셔는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
						<br><br>
				...
				<div class="terms_btn">
					...
					<button type="submit" id="terms_chk_btn" onclick="termsCheck();">확인</button>
				</div>
	...
	<script>
		...
		function termsCheck() {
			var termsService = $("#termsService[name='terms']").is(":checked");
			var termsPrivacy = $("#termsPrivacy[name='terms']").is(":checked");

			if (termsService && termsPrivacy) {
				location.href = "sinup.php";
			} else {
				alert('캠피셔 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.');
			}
		}
	</script>	
</body>
